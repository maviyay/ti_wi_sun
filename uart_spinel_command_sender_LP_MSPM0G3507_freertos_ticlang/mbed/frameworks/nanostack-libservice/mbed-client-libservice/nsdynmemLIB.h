...
#include <frameworks/nanostack-libservice/mbed-client-libservice/ns_types.h>
...
#include <frameworks/nanostack-libservice/mbed-client-libservice/nsdynmem_tracker.h>
...
#ifdef DBG_WISUN_MEM_ALLOC_TRACE
#define ns_dyn_mem_alloc(var) ns_dyn_mem_alloc_new(#var, var);
#endif
